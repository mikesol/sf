...
At face value, contravariant functors seem ridiculous. It is sort of like separating a pizza into ingredients after it has been cooked - give me a recipe that takes ingredients `a` to pizza `b`, and if you give me a cooked pizza `f b`, I'll give you back your cooked raw ingredients `f a`.
